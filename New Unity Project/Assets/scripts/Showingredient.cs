...
public class Showingredient : MonoBehaviour
{
    ...
    private Color mouseOverColor = Color.white;//声明变量为蓝色   declare the variable value of white
    ...
    void OnMouseExit()
    {
        GetComponent<Renderer>().material.color = mouseAwayColor;//当鼠标滑出时恢复物体本来颜色  change the color to the original when mouse move away
    }
